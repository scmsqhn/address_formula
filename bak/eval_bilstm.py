...
jieba.load_userdict(os.path.join(CURPATH,"model/all_addr_dict.txt"))
print(CURPATH)
sys.path.append(PARPATH)
sys.path.append(CURPATH)
sys.path.append("/home/distdev")
import databench
from databench.dbinf.mongodb_helper import MongoConn as mongo
mongoclient = mongo('myDB','cases')
...
class Eval_Ner(object):
    ...
    def data_prepare_txt(self, fname="./eval.txt"):
        result = []
        f= open(fname)
        cont = f.read()
    ...
    def predict_txt(self):
        ...
        import databench
        from databench.dbinf.mongodb_helper import MongoConn
        cli = MongoConn("myDB","evalsample")
        rec_dict={}
        rec_dict['cnt']=0
